  ...
  activities: Activity[] = [
    {
      ...
      date: '2026年7月12日',
      content: '八戸西高等学校硬式野球部の元監督であられた福田裕行先生が、令和8年7月12日、ご逝去されました。享年85。謹んでご報告申し上げますとともに、心よりご冥福をお祈り申し上げます。福田裕行先生は、1984年から1988年までの5年間にわたり本校硬式野球部の監督を務められ、選手たちの指導と部の発展に多大なるご尽力をくださいました。先生から受けた数々のご指導と温かいお言葉は、当時の部員をはじめ、卒業生・関係者一同の心に今も深く刻まれております。生前賜りましたご厚情に、部員・OB一同、心より感謝申し上げます。葬儀・告別式は左記の通り執り行われます。日時：7月17日（金）午前11時、式場：セ・リ・エ佛光堂（八戸市小中野）。ご参列をお考えの方は、上記式場までお問い合わせください。謹んでご冥福をお祈り申し上げます。'
    },
    {
      id: 'newyear-ob-2026',
      ...
      date: '2026年1月2日',
      content: '新年の幕開けとともに、今年も「パークホテル」に八戸西高校野球部OBの皆様が集結しました。毎年恒例、1月2日午後3時より開催されたOB総会。今年も会場は、西高野球部の誇りと、世代を超えた深い絆で包まれました。今年も北海道日本ハムファイターズで活躍する福島蓮投手が多忙な中駆けつけてくれました！現役プロ選手と直接言葉を交わせる貴重な機会に、会場のボルテージは最高潮に。プロの舞台で戦う後輩の姿は、私たちOBにとっても大きな誇りであり、刺激となります。今年は、記憶に新しい「甲子園の舞台」に立った若い世代も数多く参加してくれました。また、春から新社会人として羽ばたく現役大学生たちが、先輩OBたちの言葉に熱心に耳を傾ける姿も印象的でした。社会の第一線で活躍する先輩から、これから社会に出る後輩へ。野球の技術だけでなく、人生の経験談が受け継がれるのも、このOB会の醍醐味です。大盛況だった一方で、一つだけ寂しい出来事が…。実は今回、25期～45期の参加者がわずか2名でした。働き盛りでご多忙な時期かと思いますが、この世代は西高野球部の歴史を繋ぐ重要な「架け橋」です。上は創成期の先輩から、下は現役大学生・プロ選手まで。これほど幅広い世代と一度に交流できる機会は、他にはありません。同期を誘って、ぜひ会場へ足を運んでください。「久しぶり！」の一言で、あの頃の青春が蘇ります！八戸西高校野球部OB会は、より多くの皆様に参加していただけるよう、開催日時を固定しています。日時は毎年1月2日午後3時、場所はパークホテルです。この日時だけは、母校の仲間のために空けておいてください。歴史と伝統を受け継ぎ、世代を超えて繋がる同窓生たちの熱い思い。来年は、さらに多くの笑顔と再会できることを心待ちにしております。OBの皆様、来年こそは会場でお会いしましょう！',
