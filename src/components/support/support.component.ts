...
export class SupportComponent implements OnInit, AfterViewInit {
  ...
  donors: Donor[] = [
    ...
    { period: '期は確認中', names: ['三浦ひろと 様', '三浦はやと 様', 'イマカワハジメ 様', 'カスミマキヒロ 様', 'ササキタクマ 様', 'トヨカワカンイチ 様', 'フジカモリリョウコ 様', 'ツチミネナオキ 様', 'スズキノリヒコ 様', 'ワタナベマサト 様', 'ヌマハタノブミツ 様', 'タナブヒデヨ 様', 'コイズミアキヒロ 様', 'イシクラムツコ 様', 'オオヤマシゲル 様', 'オキタユウヘイ 様', 'クドウシュンヤ 様', 'タナカガク 様', 'ヤマダコウダイ 様', 'コマサワリンキ 様', 'タシママサヒロ 様', 'タカシマカツユキ 様', 'オオシタタカヨシ 様'] }
  ];
