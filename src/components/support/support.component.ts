...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, SectionTitleComponent, BackButtonComponent, RouterLink],
...
export class SupportComponent implements OnInit, AfterViewInit {
  ...
  // 昨年の入金者一覧
  donors: Donor[] = [
    { period: '1期', names: ['今川 一 様', '大久保 雅人 様', '霞 牧広 様'] },
    { period: '2期', names: ['田名部 和人 様', '天間 昭悦 様', '佐藤 幸子 様'] },
    { period: '3期', names: ['笹山 浩之 様', '工藤 都朗 様', '西 様', '三浦 俊司 様', '八田 恭章 様', '坂本 光慈 様', '貝吹 尚寿 様', 'クドウイクオ 様'] },
    { period: '5期', names: ['鈴木 徳彦 様'] },
    { period: '6期', names: ['中村 和浩 様'] },
    { period: '9期', names: ['菊地 武広 様'] },
    { period: '10期', names: ['助川 淳二 様', '沼田 傑慎 様', '榎本 直行 様', 'ウエムラケンエツ 様'] },
    { period: '11期', names: ['尾崎 昌孝 様'] },
    { period: '12期', names: ['アトムラヒデ 様'] },
    { period: '13期', names: ['木村 浩二 様', '沼田 匡弘 様', '三浦 智樹 様'] },
    ...
    { period: '25期', names: ['小川 貴史 様', '佐藤 泰正 様'] },
    ...
    { period: '46期', names: ['三浦 滉斗 様', '菊地 凜 様', '菊地マネージャー 様'] },
    { period: '銀行振込の為期は確認中です。', names: ['三浦ひろと 様', '三浦はやと 様', 'カスミマキヒロ 様', 'ササキタクマ 様', 'トヨカワカンイチ 様', 'フジカモリリョウコ 様', 'ツチミネナオキ 様', 'スズキノリヒコ 様', 'ワタナベマサト 様', 'ヌマハタノブミツ 様', 'タナブヒデヨ 様', 'コイズミアキヒロ 様', 'イシクラムツコ 様', 'オオヤマシゲル 様', 'オキタユウヘイ 様', 'クドウシュンヤ 様', 'タナカガク 様', 'ヤマダコウダイ 様', 'コマサワリンキ 様', 'タシママサヒロ 様', 'タカシマカツユキ 様', 'オオシタタカヨシ 様'] }
  ];
